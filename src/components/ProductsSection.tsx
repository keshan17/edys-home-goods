        ...
        <div className="grid grid-cols-2 md:grid-cols-3 gap-6 md:gap-8">
          {products.map((product) => (
            <a key={product.name} href="#" className="group">
              <div className="aspect-[4/5] overflow-hidden bg-card mb-4">
                <img
                  src={product.image}
                  alt={product.name}
              ...
              <h3 className="font-display text-base md:text-lg text-foreground group-hover:text-navy-light transition-colors">
                {product.name}
              </h3>
